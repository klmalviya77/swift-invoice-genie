...
const SalesReturnsListPage: React.FC = () => {
  ...
  // Filter for sales returns only
  const salesReturns = returns
    .filter(ret => ret.type === 'sales')
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Manage returns from customers</p>
        </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            View and manage all returns from customers
          </CardDescription>
        </CardHeader>
        <CardContent>
          {salesReturns.length > 0 ? (
                    ...
                    <TableCell className="text-right">
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          <DropdownMenuItem onClick={() => navigate(`/sales-returns/${returnData.id}`)}>
                            View Details
                          </DropdownMenuItem>
            ...
            <div className="rounded-lg border border-dashed p-8 text-center">
              ...
              <h3 className="mt-4 text-lg font-medium">No sales returns</h3>
              <p className="text-muted-foreground mt-2">
                Create a new sales return using the New Return button
              </p>
              <Button 
                variant="outline" 
                className="mt-4"
