...
const PurchaseReturnPage: React.FC = () => {
  ...
  useEffect(() => {
    if (selectedParty) {
      ...
      // Clear selected invoice if it's not from this supplier
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      await saveReturn(purchaseReturn);
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Create Purchase Return</h1>
        <p className="text-muted-foreground">Create a new purchase return to return items to supplier</p>
      </div>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)}>
            <CardHeader>
              ...
              <CardDescription>
                Fill in the details for this purchase return
              </CardDescription>
            </CardHeader>
